...
{
    public class FirebaseIssuerKeyProvider: IFirebaseIssuerKeyProvider
    {
        public async Task<IEnumerable<X509SecurityKey>> GetSigningKeys()
        {
            // As per https://firebase.google.com/docs/auth/admin/verify-id-tokens, the keys used can be 
